...
<form action="{{ route('p-task.update', ['id' => $task->id]) }}" method="POST">
    ...
    <div class="js_initial-disable-wrapper">
        <input id="one_day" type="radio" name="date_time" value="one_day"
            onclick="globalFunctions.toggleEnableAndDisable(['one_day_inputs'], ['multi_day_inputs'])" {{
    ...
    <br><br>
    <div class="js_initial-disable-wrapper">
        <input id="multi_day" type="radio" name="date_time" value="multi_day"
            onclick="globalFunctions.toggleEnableAndDisable(['multi_day_inputs'], ['one_day_inputs'])" {{
            old('date_time')=='multi_day' ? 'checked' : '' }}>
        ...
        <div id="multi_day_inputs" class="js_initial-disable">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="time" name="multi_day_start_time"
                value="{{ old('multi_day_start_time', substr($task->start_time, 11, 5)) }}">~
            <input type="time" name="multi_day_end_time"
                value="{{ old('multi_day_end_time', substr($task->end_time, 11, 5)) }}">
        </div>
    </div>
    <br><br>
    <div class="js_initial-disable-wrapper">
